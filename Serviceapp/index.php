<?php
// Clear any existing session when arriving at the login screen
                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            if (isset($_GET['error'])) {
                                $err = $_GET['error'];
                                if ($err === 'db') {
                                    echo '<div class="alert alert-danger w-100">Database error. Please try again later.</div>';
                                } else {
                                    echo '<div class="alert alert-danger w-100">Invalid username or password.</div>';
                                }
                            } elseif (isset($_GET['loggedout'])) {
                                echo '<div class="alert alert-success w-100">You have been logged out.</div>';
                            }
                            ?>
