    ...
    <section style="height: 600px;">
        ...
        <div class="container" style="background: rgba(8,6,6,0);width: 732px;padding-bottom: 18px;border-style: none;box-shadow: 0px 0px var(--bs-indigo);text-align: center;margin-top: 10px;">
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <form style="display: flex;"><input class="form-control" type="search" style="width: 276.9px;border-radius: 0px;" placeholder="ABC123..........."><input class="btn btn-primary" type="submit" data-bss-hover-animate="pulse" style="border-radius: 0px;background: var(--bs-black);border-style: none;" value="Search"></form>
                </div>
                <div class="col"></div>
            </div>
        </div>
